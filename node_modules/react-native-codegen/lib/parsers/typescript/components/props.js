...
function getTypeAnnotationForObjectAsArrayElement(objectType, types) {
  return {
...
function getTypeAnnotationForArrayOfArrayOfObject(typeAnnotation, types) {
...
function buildPropSchema(property, types) {
  ...
  let optional = property.optional || false; // Check for optional type in union e.g. T | null | undefined
